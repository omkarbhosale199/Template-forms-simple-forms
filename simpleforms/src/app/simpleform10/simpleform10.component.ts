...
@Component({
  selector: 'app-simpleform10',
  templateUrl: './simpleform10.component.html',
  styleUrls: ['./simpleform10.component.css']
})
export class Simpleform10Component implements OnInit {
